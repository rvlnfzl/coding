...
$sql3 ="SELECT buku.judul , buku.pengarang , penerbit.nama as
nama_penerbit FROM buku , penerbit WHERE buku.id_penerbit=penerbit.id";
$result3 = $connect->query($sql3);
$data_buku= $result3->fetch_all(MYSQLI_ASSOC);
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="form_peminjaman.php">Peminjaman</a> </td>
